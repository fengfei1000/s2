...
public class DrewNoakesJpegExifReader implements JpegExifReader {
	...
	public Map<String, String> readExif(File file) throws ExifException {
		...
		exif.put(nameMap.get(ExifIFD0Directory.TAG_MAKE),
				directory.getString(ExifIFD0Directory.TAG_MAKE));
		exif.put(nameMap.get(ExifIFD0Directory.TAG_MODEL),
				directory.getString(ExifIFD0Directory.TAG_MODEL));

		// for (Tag tag : directory.getTags()) {
		// System.out.println(tag);
		// }
		String manufacturer = exif.get(directory
				.getTagName(ExifIFD0Directory.TAG_MAKE));

		directory = metadata.getDirectory(ExifSubIFDDirectory.class);
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_EXPOSURE_TIME),
				directory.getString(ExifSubIFDDirectory.TAG_EXPOSURE_TIME));
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_SHUTTER_SPEED),
				directory.getString(ExifSubIFDDirectory.TAG_SHUTTER_SPEED));
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_FNUMBER),
		...
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_ISO_EQUIVALENT),
				directory.getString(ExifSubIFDDirectory.TAG_ISO_EQUIVALENT));
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_DATETIME_ORIGINAL),
		...
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_FOCAL_LENGTH),
		...
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_LENS_MODEL),
				directory.getString(ExifSubIFDDirectory.TAG_LENS_MODEL));
		exif.put(nameMap.get(ExifSubIFDDirectory.TAG_LENS),
		...
		if (Canon.equalsIgnoreCase(manufacturer)) {
			...
			if (directory != null)
				exif.put(
						...
						directory
								.getString(CanonMakernoteDirectory.TAG_LENS_MODEL));
		}
