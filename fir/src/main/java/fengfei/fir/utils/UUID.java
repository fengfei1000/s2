...
public class UUID {
	...
	public String toString() {
		return (digits(mostSigBits >> 32, 8) + "-" + digits(mostSigBits >> 16, 4) + "-" + digits(
				mostSigBits,
	...
	public String toB28String() {
		return (digits32(mostSigBits >> 32, 8) + "-" + digits32(mostSigBits >> 16, 4) + "-" + digits32(
				mostSigBits,
				4) + "-" + digits32(leastSigBits >> 48, 4) + "-" + digits32(leastSigBits, 12));
	}
